 ...
 * @author LAB 2 PC 13
 */
public class loginasguru extends javax.swing.JFrame {

    /**
     * Creates new form loginasguru
     */
    public loginasguru() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginasguru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginasguru().setVisible(true);
            }
        });
    }
